...
class MenuItemsControllerTest < ActionController::TestCase
  ...
  test "should create menu_item" do
    assert_difference('MenuItem.count') do
      post :create, menu_item: { code: @menu_item.code, description: @menu_item.description, name: @menu_item.name, order: @menu_item.order, price: @menu_item.price }
    end
  ...
  test "should update menu_item" do
    patch :update, id: @menu_item, menu_item: { code: @menu_item.code, description: @menu_item.description, name: @menu_item.name, order: @menu_item.order, price: @menu_item.price }
    assert_redirected_to menu_item_path(assigns(:menu_item))
  end
